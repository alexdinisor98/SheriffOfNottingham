...
public class KingQueenBonus {
    ...
    static final void equalFrequencyOfAssets(final String asset, final int[] score,
    ...
    static final void getKingBonus(final String asset, final int[] score,
                                   final int order) {
        if (asset.equals("Apple")) {
    ...
    static final void getQueenBonus(final String asset, final int[] score,
                                    final int order) {
        if (asset.equals("Apple")) {
